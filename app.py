...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Optionale gegenseitige Referenzen für spätere Orchestrierung
        self.project_scheduler.camera = self.camera
        self.project_scheduler.serial_device = self.serial_device
        self.project_scheduler.turn_table = self.turn_table
        self.project_scheduler.camera_crane = self.camera_crane
    ...
    def _replace_image_label(self):
        ...
        # Falls du Rahmen willst:
        # new_label.setStyleSheet("border: 1px solid #444;")
    ...
    def _init_ui_from_settings(self):
        """
        Lädt die aktuellen Settings in die UI.
        """
        # Inputs
    ...
    def _prepare_mode_buttons(self):
        """
        Macht die drei Buttons für Bildmodus exklusiv.
        """
        for button in (
    ...
    def _update_hdr_preview_enabled(self):
        """
        HDR preview nur aktiv, wenn Liveview aktiv ist und nicht Single-Picture-Modus.
        """
    ...
    def _on_base_tv_changed(self, text: str):
        """
        base_tv als float übernehmen und speichern.
        """
    ...
    def _on_liveview_toggled(self, checked: bool):
        ...
        # Hier später echte Liveview-Aktivierung/Deaktivierung ergänzen.
        # Aktuell nur UI-Logik.

    def _on_hdr_preview_clicked(self):
        """
        Platzhalter für spätere HDR-Vorschau.
        """
        if not self.ui.hdr_preview_button.isEnabled():
            return

        # Später:
        # - aktuelles Liveview/Probe-Bild holen
        # - HDR mit current settings rechnen
        # - in Preview Widget anzeigen
        pass
    ...
    def _update_ui(self):
        ...
        self.set_preview_pixmap(QPixmap("test.jpg"))
